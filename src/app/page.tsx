      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {areas.map((area) => (
              <div key={area.title} className="bg-white p-8 rounded-lg shadow-lg text-center">
                <h3 className="text-xl font-bold text-gray-800">{area.title}</h3>
                <p className="mt-4 text-gray-600">{area.description}</p>
                <Link
                  href={area.link}
                  className="mt-6 inline-block text-blue-800 font-bold hover:underline"
                >
                  Saiba Mais
                </Link>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="mt-8">
            <Link 
              href="/sobre"
              className="border border-blue-800 text-blue-800 font-bold py-3 px-8 rounded-lg hover:bg-blue-800 hover:text-white transition-colors duration-300"
            >
